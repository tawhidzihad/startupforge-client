...
export default function EmptyApplicationsState() {
	return (
		<div className="flex min-h-87.5 flex-col items-center justify-center rounded-3xl border border-dashed border-zinc-300 bg-background p-8 text-center dark:border-zinc-700">
